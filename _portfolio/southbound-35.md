...
- **Source:** [github.com/scottlangford2/southbound-35](https://github.com/scottlangford2/southbound-35)

Current packages:
- `posts/hays-growth/` — Hays County growth story figures
- `posts/hays-projections/` — six projection strategies compared
- `posts/spring-break-mortality/` — FARS data pipeline and 10 figures
